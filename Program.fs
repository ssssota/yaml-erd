...
let warningToConsoleString w =
  String.Format("\033[33m warning[{0}:{1}-{2}:{3}]: \033[0m {4}", w.StartLine, w.StartColumn, w.EndLine, w.EndColumn, w.Message)
...
let errorToConsoleString e =
  String.Format("\033[31m error[{0}:{1}-{2}:{3}]: \033[0m {4}", e.StartLine, e.StartColumn, e.EndLine, e.EndColumn, e.Message)
